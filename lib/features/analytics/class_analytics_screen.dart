...
enum _Sort { roll, cgpa, trend, attendance, backlogs }
      ...
      AnalyticsCard(
        ...
        child: Column(
          ...
          children: [
            ...
            AppDataTable(
              isDesktop: isDesktop,
              columns: const ['Roll No.', 'Name', 'CGPA', 'Latest', 'Trend', 'Consistency', 'Attendance', 'Backlogs', 'Signal'],
              columnFlex: const [2, 3, 1, 1, 2, 2, 2, 1, 2],
